    ...
    <body class="page-header-fixed">
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                <?php echo "<pre> Data :".print_r($categoryData , TRUE )."</pre>"; ?>
                    <div class="row">
                    <?php //echo "<pre> Data : ".print_r($categoryData , TRUE )."</pre>"; ?>
                                   ...
                                   <table id="example2" class="display table" style="width: 100%; cellspacing: 0;">
                                       <thead>
                                        ...
                                        <?php 
                                         ...
                                         ?>
                                            <tr>
                                                <td><img width="100" src="/uploads/<?php echo $categoryData[$i]['image']; ?>"></td>
                                                <td><?php echo $categoryData[$i]['name']; ?></td>
                                                <td><?php if ($categoryData[$i]['status'] == 1) {
                                                echo "Active";
                                                } else {
                                                	echo "Inactive";
                                                	} ?></td>
            ...
            function fetchCity(e) {
                ...
                var d = document.getElementById('state');
                 ...
                 for (var i = responseText.length - 1; i >= 0; i--) {
                    ...
                    option.value=responseText[i].id;
                    option.innerHTML= responseText[i].name;
